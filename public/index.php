...
<body class="p-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-2xl text-center mb-4">Gestión de Productos - Minimarket</h1>
        <form id="productForm" action="index.php" method="POST" class="w-full max-w-lg mx-auto">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="productQuantity" class="block text-gray-700 text-sm font-bold mb-2">Cantidad en
                    Inventario:</label>
